...
if __name__ == '__main__':
    ...
    # Convert the full model.
    model = full_model
    converter = tf.lite.TFLiteConverter.from_keras_model(model)
    tflite_model = converter.convert()
    with tf.io.gfile.GFile('handrate-model-full.tflite', 'wb') as f:
    ...
    converter = tf.lite.TFLiteConverter.from_keras_model(model)
    tflite_model = converter.convert()
    with tf.io.gfile.GFile('handrate-model-encoder.tflite', 'wb') as f:
      f.write(tflite_model)
    ...
    converter = tf.lite.TFLiteConverter.from_keras_model(model)
    tflite_model = converter.convert()
    with tf.io.gfile.GFile('handrate-model-decoder.tflite', 'wb') as f:
      f.write(tflite_model)
